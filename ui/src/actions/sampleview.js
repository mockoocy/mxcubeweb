...
import {
  addShape as addShapeMutation,
  deleteShape as deleteShapeMutation,
  updateShapes as updateShapesMutation,
...
export function addShape(shapeData = {}) {
  return async (dispatch) => {
    try {
      ...
      dispatch(addShapeMutation(shape));
      return shape;
    } catch {
...
export function updateShapes(shapes) {
  return async (dispatch) => {
    try {
      ...
      dispatch(updateShapesMutation(json.shapes));
    } catch {
...
export function deleteShape(id) {
  return async (dispatch) => {
    try {
      ...
      dispatch(deleteShapeMutation(id));
    } catch {
